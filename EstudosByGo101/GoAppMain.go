...
func main() {
	//TesteLoop()
	//SlicesMapsStructs_Slices()
	//SlicesMapsStructs_Maps()
	//SlicesMapsStructs_Structs()
	SlicesMapsStructs_Structs()
}
...
func SlicesMapsStructs_Structs() {
